...
object ObjectOrientaiton extends App{
  ...
  //aDog.name //compiler complains

  // constructor values are not fields: need to put a val before the constructor argument
  //e.g.
  ...
  object MySingleton { // the only instance of MySingleton type
    val mySpecialValue = 3466
    def mySpecialMethod(): Int = 33456
  ...
  /*
  - compiler generates sensible equals and hash code
  - serialization - like with Akka
  ...
  */
  ...
  // generics - feature of a statically typed languge
